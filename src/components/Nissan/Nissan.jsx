...
function FairLady(props) {
    const { scene, nodes, materials } = useGLTF('3D_Models/Nissan/nissan_fairlady.glb');
    useLayoutEffect(() => {
...
function N300ZX(props) {
    const { scene, nodes, materials } = useGLTF('3D_Models/Nissan/300zx.glb');
    useLayoutEffect(() => {
        scene.traverse((obj) => obj.type === 'Mesh' && (obj.recieveShadow = obj.castShadow = true))
    }, [scene, nodes, materials])
    return <primitive object={scene} {...props} />
...
function R32GTR(props) {
    const { scene, nodes, materials } = useGLTF('3D_Models/Nissan/r32_gt-r.glb');
    useLayoutEffect(() => {
        scene.traverse((obj) => obj.type === 'Mesh' && (obj.recieveShadow = obj.castShadow = true))
        Object.assign(materials.Material_003, { roughness: 0.0, metalness: 0.3, color: new THREE.Color('#fff'), envMapIntensity: 0.5 })
    }, [scene, nodes, materials])
    return <primitive object={scene} {...props} />
}
